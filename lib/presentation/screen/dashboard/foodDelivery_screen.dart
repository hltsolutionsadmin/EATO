...
import 'package:eato/presentation/screen/dashboard/restaurantMenu_screen.dart';
import 'package:eato/presentation/screen/widgets/foodDelivery/foodCatagoryIcons.dart';
import 'package:eato/presentation/screen/widgets/foodDelivery/foodItemCard.dart';
import 'package:eato/presentation/screen/widgets/locationHeader.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  Expanded(
                    child: BlocBuilder<GetNearbyRestaurantsCubit,
                        GetNearbyRestaurantsState>(
                        ...
                        if (state is GetNearbyRestaurantsLoading) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final data = {
                                "Restaurant":
                                    restaurant.businessName ?? "Unknown",
